...
_RATHENA_PROMPT_AXIOMS: tuple[str, ...] = (
    ...
    "Prontera Tool Dealer NPC at prt_in (126, 76) sells: item 501=Red Potion (10z), 502=Orange Potion (50z), 503=White Potion (180z). Use 'buy <item_id> <amount>' to purchase.",
