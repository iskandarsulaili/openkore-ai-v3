...
def create_opportunistic_trader_agent(*, llm: Any, tools: list[Any], verbose: bool) -> Any:
    profile = next(item for item in AGENT_PROFILES if item.agent_id == "opportunistic_trader")
