...
def create_resource_manager_agent(*, llm: Any, tools: list[Any], verbose: bool) -> Any:
    profile = next(item for item in AGENT_PROFILES if item.agent_id == "resource_manager")
