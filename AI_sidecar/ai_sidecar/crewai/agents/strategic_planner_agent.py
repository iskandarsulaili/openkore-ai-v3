...
def create_strategic_planner_agent(*, llm: Any, tools: list[Any], verbose: bool) -> Any:
    profile = next(item for item in AGENT_PROFILES if item.agent_id == "strategic_planner")
