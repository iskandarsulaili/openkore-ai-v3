...
| C3 | Wire LLM/crewAI to make gear/consumable decisions adaptively (RULE.md hard rule) | 🔶 in progress | RULE.md mandate committed `95f258816`; LLM wiring in progress |
