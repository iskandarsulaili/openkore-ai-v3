...
| Satu bot | Kawanan multi-bot |
| Tanpa kontrol biaya | Anggaran per bot, tingkat bertahap |
| Makro komunitas saja | Pembelajaran bersama antar bot |
| Bereaksi terhadap kondisi | Merencanakan dengan PDCA |

---

## Fitur

- 3 tingkat: 25 aturan refleks → 17 profil heuristik → LLM
- Kawanan multi-bot dengan penetapan peran otomatis
- Belajar mandiri: meningkat per aksi/peta/monster
- Kontrol biaya: off/economy/standard/premium
- 30+ mekanik RO
- Percakapan NPC bertenaga LLM
- Konsol langsung dengan start.sh
- 25 endpoint FastAPI
- Kompatibel dengan konfigurasi OpenKore asli
