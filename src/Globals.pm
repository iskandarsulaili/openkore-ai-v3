...
our $encryptVal;
our $ipc;
our $mapLoginAcked;  # 2026-09-03: set in map_loaded, cleared on disconnect — gates the 0x0B1C ping so it never coalesces with 0x0436 on reconnect (IN_GAME state stays stale across reconnect)
our $bus;
